...
export function Hero() {
  ...
  return (
    <section className="relative bg-background py-24 transition md:py-36">
      <Divider />
          ...
          >
            ...
            <div className="flex flex-col gap-5">
              ...
              <p className="max-w-lg text-balance text-foreground/70 text-lg leading-relaxed md:text-xl">
                {COMPONENT_COUNT} drop-in components for your shadcn/ui project
                — one command, Motion-powered, fully typed.
              </p>
            </div>
