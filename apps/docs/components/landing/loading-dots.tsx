...
export function LoadingDots({ className, size = 24, showText = true }: LoadingDotsProps) {
  ...
  return (
    <div className="flex flex-col items-center gap-4">
      ...
      <g clipPath="url(#clip0_331_2)">
        <mask id="mask0_331_2" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} x="0" y="0">
          <path d="M24 0H0V24H24V0Z" fill="white" />
        </mask>
        <g mask="url(#mask0_331_2)">
          <mask id="mask1_331_2" maskUnits="userSpaceOnUse" style={{ maskType: "luminance" }} x="0" y="0">
            <path d="M0 0H24V24H0V0Z" fill="white" />
          </mask>
          <g mask="url(#mask1_331_2)">
            {/* Row 1 */}
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[0][0]}s` }}>
              <path
                d="M5.6 7.2C6.484 7.2 7.2 6.484 7.2 5.6C7.2 4.716 6.484 4 5.6 4C4.716 4 4 4.716 4 5.6C4 6.484 4.716 7.2 5.6 7.2Z"
                fill="currentColor"
              />
            </g>
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[0][1]}s` }}>
              <path
            ...
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[0][2]}s` }}>
              <path
            ...
            {/* Row 2 */}
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[1][0]}s` }}>
              <path
            ...
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[1][1]}s` }}>
              <path
            ...
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[1][2]}s` }}>
              <path
            ...
            {/* Row 3 */}
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[2][0]}s` }}>
              <path
            ...
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[2][1]}s` }}>
              <path
            ...
            <g className="dot-animate" style={{ animationDelay: `${dotDelays[2][2]}s` }}>
              <path
