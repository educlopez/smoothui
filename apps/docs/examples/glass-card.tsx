      ...
      <div className="relative flex size-full flex-col justify-center gap-4 p-5">
        <GlassCard className="w-full" radius={28}>
          <div className="flex items-center gap-3">
            <div
              aria-hidden="true"
              className="size-14 shrink-0 rounded-lg bg-[url(https://ik.imagekit.io/16u211libb/smoothui/scenes/cobalt-pink.webp?tr=w-160,h-160,f-auto)] bg-center bg-cover ring-1 ring-white/25 ring-inset"
            />
