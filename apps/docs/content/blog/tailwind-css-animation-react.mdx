...
3. **Use pre-built components for common patterns** — [SmoothUI](https://smoothui.dev) provides {COMPONENT_COUNT} animated components that combine Tailwind styling with Motion animations, all shadcn-compatible
