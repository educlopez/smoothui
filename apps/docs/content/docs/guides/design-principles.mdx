...
description: Explore SmoothUI's design principles including theming, accessibility, animation standards, and Tailwind CSS customization options.
---
...
:root {
  ...
  --shimmer-highlight: var(--color-smooth-200);
  --shimmer-base: var(--color-smooth-1000);
  --radius: 0.625rem;
}
  ...
  .loading-shimmer {
    ...
    background: var(--shimmer-base)
      gradient(
        ...
        100% 0,
        0 0,
        from(var(--shimmer-base)),
        color-stop(0.5, var(--shimmer-highlight)),
        to(var(--shimmer-base))
      );
    background: var(--shimmer-base) -webkit-gradient(
        linear,
        100% 0,
        0 0,
        from(var(--shimmer-base)),
