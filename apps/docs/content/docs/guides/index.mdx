---
title: Introduction
description: SmoothUI is a collection of beautifully designed components with smooth animations built with React, Tailwind CSS, Motion, and GSAP.
icon: Album
---
...
<FeatureCardHover
  ...
  description="Powered by Motion and GSAP for fluid, performant animations that enhance user experience."
...
<Accordion id="do-i-need-to-know-framer-motion-to-use-smoothui" title="Do I need to know Motion or GSAP to use SmoothUI?">
