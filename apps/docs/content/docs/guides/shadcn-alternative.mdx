...
description: SmoothUI adds smooth Motion and GSAP animations to the shadcn/ui ecosystem. Compare features and discover animated React components.
---
...
| Component Count | 40+ | {COMPONENT_COUNT} |
...
>
  Explore {COMPONENT_COUNT} animated components ready to use.
</Card>
</Cards>
