---
title: SmoothUI vs shadcn/ui - The Animated Alternative
description: Looking for a shadcn/ui alternative with animations? SmoothUI adds smooth Motion animations to the shadcn ecosystem. Compare features and see why developers choose SmoothUI for animated React components.
icon: Sparkles
---
...
<Accordion id="performance" title="Do animations affect performance?">
  SmoothUI animations are built with Motion and optimized for performance. They use GPU-accelerated transforms and respect the user's reduced motion preferences for accessibility.
</Accordion>
</Accordions>
