...
description: "{{components}} animated React components built with Motion (Framer Motion) and GSAP. Smooth hover effects, transitions, and interactive UI."
---
...
| [Animated OTP Input](/docs/components/animated-o-t-p-input) | Digit animation | Verification flows |
...
>
  Explore the complete collection of {COMPONENT_COUNT} animated components.
</Card>
