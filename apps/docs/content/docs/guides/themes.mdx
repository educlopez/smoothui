...
[smoothui.dev/playground](https://smoothui.dev/playground) is an interactive studio: a draggable board previewing the entire component registry with your theme applied live.
...
```
https://smoothui.dev/playground?preset=s1.candy.16.20.mono.warm
```
