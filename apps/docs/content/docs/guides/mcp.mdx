...
<Card title="AI Integration" href="/docs/guides/ai-integration">
...
<BodyText>
You can also read more about the shadcn MCP protocol in the <a href="https://ui.shadcn.com/docs/mcp" target="_blank" rel="noopener noreferrer" className="text-brand hover:underline">shadcn MCP documentation</a>.
</BodyText>
