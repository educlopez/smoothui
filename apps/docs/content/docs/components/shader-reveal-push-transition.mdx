---
title: Noise Push Transition
description: "Procedural noise push and pull displacement."
icon: ArrowRightLeft
dependencies:
  - motion.dev
installer: shader-reveal-push-transition
---
...
<AutoTypeTable
  path="../../packages/smoothui/components/shader-reveal-push-transition/index.tsx"
  name="ShaderRevealPushTransitionProps"
/>
