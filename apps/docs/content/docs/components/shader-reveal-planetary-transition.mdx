---
title: Planetary Swirl Transition
description: "Rotated displacement vectors with a planetary swirl feel."
icon: Globe
dependencies:
  - motion.dev
installer: shader-reveal-planetary-transition
---
...
<AutoTypeTable
  path="../../packages/smoothui/components/shader-reveal-planetary-transition/index.tsx"
  name="ShaderRevealPlanetaryTransitionProps"
/>
