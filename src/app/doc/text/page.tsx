...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Text Components - SmoothUI",
    description:
      "Animated text components with stunning effects built with TailwindCSS and Framer Motion.",
    type: "website",
    url: "/doc/text",
    images: [
      {
        width: 1920,
        height: 1080,
        url: "/api/og?title=Text%20Components&description=Animated text components with stunning effects built with TailwindCSS and Framer Motion",
        alt: "SmoothUI Text Components showcase",
      },
    ],
    siteName: "SmoothUI",
  },
...
export default function TextComponentsPage() {
  ...
  const featuredComponents = textComponents.slice(0, 6)

  return (
    <div className="container mx-auto max-w-4xl space-y-4 px-4 py-8">
      <Breadcrumbs
        category="Documentation"
        groupName="Text Components"
        backLink="/doc"
      ...
      <div className="mb-8">
        <h1
          ...
          data-table-content="Text Components"
          data-level="1"
        >
          Text Components
        </h1>
        <p className="text-foreground/70 mt-4 text-lg">
          Animated text components with stunning effects built with TailwindCSS
          and Framer Motion. Add life to your text with smooth animations, hover
          effects, and engaging interactions.
        </p>
      </div>
          ...
          >
            ...
            <CardContent className="pt-0">
              ...
              <div className="flex items-center justify-between">
                ...
                >
                  <Link href={`/doc/text/${component.slug}`}>
                    View Component
      ...
      <div className="bg-primary mt-12 rounded-lg border p-6">
        ...
        <p className="text-foreground/70 mb-4">
          Explore our basic components and advanced components for more UI
          elements.
        </p>
