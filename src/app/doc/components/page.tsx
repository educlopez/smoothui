...
export const metadata: Metadata = {
  title: "Components",
  description:
    "Explore our collection of beautifully animated React components built with TailwindCSS and Framer Motion.",
  alternates: {
    canonical: "/doc/components",
  },
  openGraph: {
    title: "Components - SmoothUI",
    description:
      "Explore our collection of beautifully animated React components built with TailwindCSS and Framer Motion.",
    type: "website",
    url: "/doc/components",
    images: [
      {
        width: 1920,
        height: 1080,
        url: "/api/og?title=Components&description=Explore our collection of beautifully animated React components built with TailwindCSS and Framer Motion",
        alt: "SmoothUI Components showcase",
      },
    ],
    siteName: "SmoothUI",
  },
    ...
    <div className="container mx-auto max-w-4xl space-y-4 px-4 py-8">
      ...
      <div className="mb-8">
        ...
        <p className="text-foreground/70 mt-4 text-lg">
          Explore our collection of beautifully animated React components built
          with TailwindCSS and Framer Motion. Each component is designed to
          enhance your user interface with smooth, engaging animations.
        </p>
      </div>
        ...
        {featuredComponents.map((component) => (
          ...
          >
            ...
            <CardContent className="pt-0">
              ...
              {/* Component Demo */}
              <div className="bg-primary/30 mb-4 rounded-lg border p-4">
      ...
      <div className="bg-primary mt-12 rounded-lg border p-6">
        ...
        <p className="text-foreground/70 mb-4">
          Check out our basic components and text components for more UI
          elements.
        </p>
