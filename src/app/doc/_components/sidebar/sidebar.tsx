...
export function Sidebar() {
  return (
    <aside className="sticky top-0 hidden h-screen flex-1 flex-col overflow-y-auto overflow-x-visible border-r border-light3 bg-light2 p-6 pt-7 transition dark:border-dark3 dark:bg-dark2 lg:flex">
