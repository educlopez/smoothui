...
const buttonVariants = cva(
  "inline-flex cursor-pointer gap-2 items-center justify-center whitespace-nowrap rounded-md text-sm font-medium ring-offset-background transition-colors focus-visible:outline-hidden focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default:
        ...
        outline:
          "bg-background hover:bg-primary hover:text-foreground shadow-custom-btgray",
        secondary:
