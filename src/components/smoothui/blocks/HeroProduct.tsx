            ...
            <div className="relative z-10 mx-auto max-w-5xl px-6 text-center">
              <AnimatedGroup preset="blur-slide" className="space-y-8">
                ...
                >
                  <Link
                    href="#"
                    className="hover:bg-foreground/5 mx-auto flex w-fit items-center justify-center gap-2 rounded-md py-0.5 pr-3 pl-1 transition-colors duration-200 ease-out"
                  >
                    <svg
                ...
                <AnimatedText
                  as="h1"
                  className="mx-auto mt-8 max-w-3xl text-4xl font-bold tracking-tight text-balance sm:text-5xl"
                  delay={0.2}
                >
                  {heading}
                </AnimatedText>
                ...
                <AnimatedText
                  as="p"
                  className="text-muted-foreground mx-auto my-6 max-w-xl text-xl text-balance"
                  delay={0.3}
                >
                  {description}
                </AnimatedText>
